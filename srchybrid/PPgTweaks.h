...
protected:
	...
	bool m_bDebug2Disk;
	int m_iCommitFiles;
	//bool m_bFilterLANIPs; // ismod: do not filter lan ips
	bool m_bExtControls;
	UINT m_uServerKeepAliveTimeout;
	int m_iSpaceAllocPolicy; // ismod
    ...
    //HTREEITEM m_htiFilterLANIPs; // ismod: do not filter lan ips
	HTREEITEM m_htiExtControls;
	HTREEITEM m_htiServerKeepAliveTimeout;
	HTREEITEM m_htiSpaceAllocPolicy; // ismod: space alloc group
