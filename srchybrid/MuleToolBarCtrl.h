...
// ismod
#define	TBBTN_SCT		(IDC_TOOLBARBUTTON + 12)
#define	TBBTN_XCAT		(IDC_TOOLBARBUTTON + 13)

#define COUNT_TBBTN     14
...
protected:
	...
	int			m_buttoncount;
	TBBUTTON	TBButtons[COUNT_TBBTN];
	TCHAR		TBStrings[COUNT_TBBTN][200];
