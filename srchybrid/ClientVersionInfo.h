...
public:
	...
	CClientVersionInfo(uint32_t dwTagVersionInfo, UINT nClientMajor)
	{
	...
	CClientVersionInfo(uint32_t nVerMajor, uint32_t nVerMinor, uint32_t nVerUpdate, uint32_t nVerBuild, uint32_t ClientTypeMajor, uint32_t ClientTypeMinor = SO_UNKNOWN)
	{
