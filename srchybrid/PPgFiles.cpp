...
BOOL CPPgFiles::OnInitDialog()
{
	...
	SetButtonIcon(::GetDlgItem(m_hWnd, IDC_BROWSEV), m_icoBrowse);
...
void CPPgFiles::LoadSettings(void)
{
	...
	CheckDlgButton(IDC_FNCLEANUP, (uint8_t)thePrefs.AutoFilenameCleanup());
...
void CPPgFiles::OnSettingsChangeCat(uint8_t index)
{
