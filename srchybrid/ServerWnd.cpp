...
bool CServerWnd::AddServer(uint16_t nPort, CString strAddress, CString strName, bool bShowErrorMB)
{
	...
	*pResult = 0;
	...
	if (pEnLink && pEnLink->msg == WM_LBUTTONDOWN)
	{
        ...
        */
		...
		// ismod: ed2k club link
		if (strUrl == m_strED2kClub){
			strUrl = _T("http://city.is74.ru/forum/forumdisplay.php?f=134");
		}
