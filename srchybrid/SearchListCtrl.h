...
public:
	uint32_t	m_nSortItem;
	bool	m_bSortAscending;
	uint32_t	m_nScrollPosition;
...
private:
	void ExpandCollapseAll(int iAction);
    void TryToConnect(CSearchFile *file);
	void AddCatalogToDownload(const CSearchFile *file);
};
