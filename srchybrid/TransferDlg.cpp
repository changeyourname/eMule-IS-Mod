...
void CTransferDlg::ShowQueueCount(uint32_t number)
{
...
int	CTransferDlg::AddCategory( LPCTSTR newtitle, LPCTSTR newincoming, LPCTSTR newcomment, LPCTSTR newautocat, bool addTab )
{
...
// ismod [start]
void CTransferDlg::SetDownloadBarFile( CPartFile *file )
{
	m_pwndTransfer->SetDownloadBarFile(file);
}

void CTransferDlg::UpdateDownloadBar()
{
	m_pwndTransfer->UpdateDownloadBar();
}

CPartFile* CTransferDlg::GetDownloadBarFile()
{
	return m_pwndTransfer->GetDownloadBarFile();
}
