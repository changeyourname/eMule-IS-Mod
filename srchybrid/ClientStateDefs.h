...
#else
#define _EClientSoftware	uint8_t
#define _EChatState			uint8_t
#define _EKadState			uint8_t
#define _ESecureIdentState	uint8_t
#define _EUploadState		uint8_t
#define _EDownloadState		uint8_t
#define _ESourceFrom		uint8_t
#define _EChatCaptchaState	uint8_t
#define _EConnectingState	uint8_t
#endif