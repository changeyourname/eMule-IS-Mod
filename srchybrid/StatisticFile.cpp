...
void CStatisticFile::AddTransferred(uint64_t bytes){
	transferred += bytes;
...
void CStatisticFile::SetAllTimeRequests(uint32_t nVal)
{
	alltimerequested = nVal;
}

void CStatisticFile::SetAllTimeAccepts(uint32_t nVal)
{
	alltimeaccepted = nVal;
}

void CStatisticFile::SetAllTimeTransferred(uint64_t nVal)
{
