...
public:
	...
	void	OnInit(CHeaderCtrl* pColumnHeader, CArray<int>* paIgnoredColums = NULL);
    ...
    void    SetDelayedEvaluateMessage( UINT message ) { m_uDelayedEvaluateMessage = message; }
...
protected:
	...
	CArray<int> m_aIgnoredColums;
    UINT        m_uDelayedEvaluateMessage;
