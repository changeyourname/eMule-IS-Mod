...
#ifdef _DEBUG
#define EMULE_ISMOD_GUID				_T("EMULE-ISMOD-{912C3CF8-AA86-4517-A649-200C6C7DD250}-DEBUG")
#else
#define EMULE_ISMOD_GUID				_T("EMULE-ISMOD-{912C3CF8-AA86-4517-A649-200C6C7DD250}")
#endif
...
*/
#define	FILEREASKTIME			MIN2MS(5)	//5 mins
...
*/
#define SERVERREASKTIME			MIN2MS(5)	//5 mins - don't set this too low, it wont speed up anything, but it could kill emule or your internetconnection
/* ismod
#define UDPSERVERREASKTIME		MIN2MS(30)	//30 mins
*/
#define UDPSERVERREASKTIME		MIN2MS(20)	//20 mins

#define	MAX_SERVERFAILCOUNT		10
/* ismod
#define SOURCECLIENTREASKS		MIN2MS(40)	//40 mins
*/
#define SOURCECLIENTREASKS		MIN2MS(15)	//40 mins
...
*/
#define SESSIONMAXTIME			MIN2MS(30)	//30 min
...
*/
#define	UPLOAD_CLIENT_DATARATE	3145728		// uploadspeed per client in bytes - you may want to adjust this if you have a slow connection or T1-T3 ;)
#define	MAX_UP_CLIENTS_ALLOWED	50			// max. clients allowed regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too low, use DATARATE to adjust uploadspeed per client
#define	MIN_UP_CLIENTS_ALLOWED	4		// min. clients allowed to download regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too high

/* ismod
#define DOWNLOADTIMEOUT			SEC2MS(100)
*/
#define DOWNLOADTIMEOUT			SEC2MS(30)
...
*/
#define	MIN_REQUESTTIME			MIN2MS(2) 
...
*/
#define EMBLOCKSIZE				368640ui64 //  x2
...
// ismod [start]
#define OP_ASKDIRCONTENTS       0xB2
#define OP_ASKDIRCONTENTSANS    0xB3
// ismod [end]
...
// ismod: search folders and users [start]
#define ED2KFTSTR_FOLDER	    "Folder" // Value for eD2K tag FT_FILETYPE
#define ED2KFTSTR_USER	        "User" // eMule internal use only
// ismod [end]
...
// BEGIN netfinity: Mod specific settings and opcodes
#define DELAYED_NNP_TIMOUT				SEC2MS(30)