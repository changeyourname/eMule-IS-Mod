...
SSearchParams* CSearchDlg::GetSearchParamsBySearchID(uint32_t nSearchID){
...
void CSearchDlg::SetNextSearchID(uint32_t uNextID)
{ 
...
bool CSearchDlg::CanDeleteSearch(uint32_t nSearchID) const
{
...
void CSearchDlg::DeleteSearch(uint32_t nSearchID)
{
