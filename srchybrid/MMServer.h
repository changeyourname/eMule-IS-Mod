...
public:
	...
	void	StopServer();
	// packet processing
	bool	PreProcessPacket(char* pPacket, uint32_t nSize, CMMSocket* sender);
...
private:
	...
	uint8_t				m_cPWFailed;
	uint32_t				m_dwBlocked;
	bool				m_bUseFakeContent;
	uint16_t				m_nMaxDownloads;
	uint16_t				m_nMaxBufDownloads;
