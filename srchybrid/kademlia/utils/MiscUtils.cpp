...
void CMiscUtils::IPAddressToString(uint32_t uIP, CString *pString)
{
...
void CMiscUtils::DebugHexDump(const byte *pbyData, uint32_t uLenData)
{
#ifdef DEBUG
	try
	{
		...
		while (uPos < uLenData)
		{
			...
			iLenLine = min<int>((uLenData - uPos), 16);
