...
namespace Kademlia
{
	...
	class CKadTag
	{
		public:
			...
			virtual uint8_t GetBsobSize() const
			{
				ASSERT(0);
				return 0;
			}
	...
	{
		public:
			CKadTagUInt(LPCSTR name, uint64_t value)
					: CKadTag(0xFE, name)
					, m_value(value)
			{ }
	...
	{
		public:
			CKadTagUInt64(LPCSTR name, uint64_t value)
	...
	{
		public:
			CKadTagUInt32(LPCSTR name, uint32_t value)
	...
	{
		public:
			CKadTagUInt16(LPCSTR name, uint16_t value)
	...
	{
		public:
			CKadTagUInt8(LPCSTR name, uint8_t value)
	...
	{
		public:
			CKadTagBsob(LPCSTR name, const BYTE* value, uint8_t nSize)
