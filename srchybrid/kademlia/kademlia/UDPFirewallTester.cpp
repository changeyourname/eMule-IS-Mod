...
uint8_t CUDPFirewallTester::m_byFWChecksRunningUDP = 0;
uint8_t CUDPFirewallTester::m_byFWChecksFinishedUDP = 0;
uint32_t CUDPFirewallTester::m_dwTestStart = 0;
uint32_t CUDPFirewallTester::m_dwLastSucceededTime = 0;
...
void CUDPFirewallTester::SetUDPFWCheckResult(bool bSucceeded, bool bTestCancelled, uint32_t uFromIP, uint16_t nIncomingPort){	
...
void CUDPFirewallTester::AddPossibleTestContact(const CUInt128 &uClientID, uint32_t uIp, uint16_t uUdpPort, uint16_t uTcpPort, const CUInt128 &uTarget, uint8_t uVersion, CKadUDPKey cUDPKey, bool bIPVerified){
