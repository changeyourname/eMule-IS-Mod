...
namespace Kademlia
{
	class CContact
	{
		...
		public:
			~CContact();
			CContact();
			CContact(const CUInt128 &uClientID, uint32_t uIp, uint16_t uUdpPort, uint16_t uTcpPort, uint8_t uVersion, CKadUDPKey cUDPKey, bool bIPVerified);
			CContact(const CUInt128 &uClientID, uint32_t uIp, uint16_t uUdpPort, uint16_t uTcpPort, const CUInt128 &uTarget, uint8_t uVersion, CKadUDPKey cUDPKey, bool bIPVerified);	
			...
			void SetVersion(uint8_t uVersion);
