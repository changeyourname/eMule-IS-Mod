...
void CPPgSecurity::LoadSettings(void)
{
	...
	if ((thePrefs.GetWindowsVersion() == _WINVER_XP_ || thePrefs.GetWindowsVersion() == _WINVER_2003_)
		&& thePrefs.m_portableMode)
...
BOOL CPPgSecurity::OnApply()
{
	...
	/* ismod: protocol encription disabled
	...
	*/
	thePrefs.m_bCryptLayerRequested = false;
	thePrefs.m_bCryptLayerRequired = false;
	thePrefs.m_bCryptLayerSupported = false;
